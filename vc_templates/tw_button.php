...
if ($atts['animate_icon'] && !empty($icon)) {
    $output='<a href="'.esc_url($link['url']).'" '.($target).' title="'.esc_attr($link['title']).'" class="uk-button uk-button-default tw-hover'.$btnclass.'" style="'.$style.'"><span class="tw-hover-inner"><span>' . esc_html($link['title']).'</span>'.$icon.'</span></a>';
} else {
    $output='<a href="'.esc_url($link['url']).'" '.($target).' title="'.esc_attr($link['title']).'" class="uk-button uk-button-default no-hover'.$btnclass.'" style="'.$style.'">' . esc_html($link['title']).$icon.'</a>';
}
echo ($output);