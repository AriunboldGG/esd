...
if ( $footer_layout ) {
    ...
    <div class="bottom-area uk-light">
        <div class="uk-container<?php echo esc_attr( $container_class );?>">
            <div class="<?php echo esc_attr( $footer_layout_class ); ?>" data-uk-grid data-uk-scrollspy="target: > div; cls:uk-animation-fade; delay: 200;"><?php
...
<div class="footer-area footer-small uk-light">
    <div class="uk-container<?php echo esc_attr( $container_class );?>">
        <div class="uk-flex-middle uk-child-width-1-1 uk-child-width-expand@m" data-uk-grid><?php
            ...
            if ( ! empty( $text_right ) ) {
                echo '<div class="uk-text-right"><a href="#" title="'.esc_attr__('Scroll to top','lvly').'" data-uk-scroll>';
                echo wp_kses_post( $text_right );
                echo '<i class="ion-ios-arrow-up uk-margin-small-left"></i></a></div>';
            } ?>
        </div>
    </div>
</div>